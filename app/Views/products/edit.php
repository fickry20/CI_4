    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="/profile">Profile</a></li>
                <li class="menu-item hidden"><a href="/about">About</a></li>
                <li class="menu-item hidden"><a href="/products">Product</a></li>
            ...
            <section>
                ...
                <table id="productTable" class="display">
                    <form action="/product/update/<?= $product['id']; ?>" method="post" enctype="multipart/form-data">
                        <thead>
                            <tr>
                                <th><label for="nama">Nama Produk</label></th>
                                <th<input type="text" name="nama" id="nama" value="<?= esc($product['nama']); ?>" required>
                                    </th>
                            </tr><br>
                            <tr>
                                <th><label for="price">Harga</label></th>
                                <th<input type="text" name="price" id="price" value="<?= esc($product['price']); ?>" required>
                                    </th>
                            </tr><br>
                            <tr>
                                <th><label for="ket">Deskripsi</label></th>
                                <th><textarea name="ket" id="ket" value="<?= esc($product['ket']); ?>"></textarea></th>
                            </tr><br>
                            <tr>
                                <th><label for="kategori">Kategori</label></th>
                                <th<input type="text" name="kategori" id="kategori" value="<?= esc($product['kategori']); ?>" required>
                                    </th>
                            </tr>
                            <tr>
                                <th><label for="product_image">Upload Foto</label></th>
                                <th><input type="file" name="product_image" id="product_image" value="<?= esc($product['image']); ?>" required></th>
