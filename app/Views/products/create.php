...
<head>
    ...
    <!-- CSS DataTables -->
    <link rel="stylesheet" href="https://cdn.datatables.net/2.1.8/css/dataTables.dataTables.min.css"></link>
...
<table id="productTable" class="display>
    <form action="/product/store" method="post" enctype="multipart/form-data">
        <thead>
            <tr>
                <th><label for="name">Nama Produk</label></th>
...
<tr>
            <tr>
                <th><label for="ket">Keterangan</label></th>
                <th><textarea name="ket" id="ket" required></textarea></th>
</tr><br>
<tr>
            <tr>
                <th><label for="kategori">Kategori</label></th>
                <th><input type="text" id="kategori" required></th>
                <tr>
            <tr>
                <th><label for="product_image">Upload Foto</label></th>
                <th><input type="file" name="product_image" id="product_image" required></th>
                <tr>
                    <th><button type="submit">Simpan</button><th>
</tr><br>
<tr>
</table>
    </section>
